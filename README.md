...
flowchart TD
    ...
    subgraph DataPrep ["1. DATA PIPELINE"]
        ...
        C["knowledge_base.json<br/>Consolidated Medical KB<br/>(138 Chunks)"]:::gray
    end
...
*   **Tuân thủ Hướng dẫn Lâm sàng (Guideline Adherence)**: **100.0% (46/46)** — Chỉ định đi khám đúng tuyến y tế chuyên khoa kịp thời.
*   **Độ an toàn khuyến cáo (Safety)**: **87.0% (40/46)** — *[Yêu cầu bắt buộc đạt 100% để ứng dụng thực tế]*. Đã loại bỏ hoàn toàn các lỗi sơ cứu nguy hiểm (như nằm đầu thấp khi ho ra máu) nhờ cơ chế Conditional Prompting.
*   **Nhận diện Rủi ro Chính (Risk Recognition)**: **87.0% (40/46)** — Nhận diện được triệu chứng báo động đỏ.
*   **Phân loại Mức độ Khẩn cấp (Grading Accuracy)**: **84.8% (39/46)**.
*   **Giải thích Hội thoại (Conversational Explanation)**: **97.8% (45/46)**.
*   **Độ rõ ràng (Clarity)**: **4.54 / 5.0** (Thang điểm Likert).
...
## 🏥 Nguồn Dữ liệu Y khoa (138 Chunks)
