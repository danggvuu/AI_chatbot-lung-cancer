...
[LƯU Ý LÂM SÀNG]
- BẮT BUỘC soạn thảo toàn bộ câu trả lời bằng tiếng Việt. Tuyệt đối không soạn câu bằng tiếng Trung hoặc tiếng Anh.
- ĐƯỢC PHÉP giữ nguyên các viết tắt thuật ngữ y khoa quốc tế thông dụng (như NSCLC, SCLC, EGFR, ALK, SVCO, LDCT, TNM) để đảm bảo tính chuyên môn y học.
...
async def chat(request: Request):
    ...
    user_enriched_content = (
        ...
        f"LƯU Ý: Phải viết câu trả lời bằng tiếng Việt! Tuyệt đối không soạn thảo câu bằng tiếng Trung hoặc tiếng Anh (tuy nhiên được phép giữ nguyên các thuật ngữ viết tắt y khoa quốc tế như EGFR, ALK, NSCLC, SCLC)."
    )
